...
class command extends Command {
    ...
    async run (message, args, client) {
        try{
            if(message.channel.id === '1313101836147757067'){
                message.delete();
                ...
                switch (args[0].toLowerCase()) {
                    case 'нанять':
                        member.roles.add(['1312830971888009248']);
                        ...
                        message.guild.channels.cache.get('1315400378564476968').send({embed:emb});
                    ...
                    case 'снять': {
                        member.roles.remove(['1312830971888009248']);
