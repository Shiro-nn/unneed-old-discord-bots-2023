module.exports = class {
    ...
    async run (message) {
        if(/(\b(https?|ftp|file):\/\/(?!(tenor.com))(?!((.+?).tenor.com))(?!(discord.com))(?!((.+?).discord.com))(?!(discordapp.com))(?!((.+?).discordapp.com))(?!((.+?).discordapp.net))(?!((.+?)..ru))(?!(.ru))([-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|]))/ig.test(message.content)){
            try{
