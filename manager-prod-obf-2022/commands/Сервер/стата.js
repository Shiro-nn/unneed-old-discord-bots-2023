...
class stata extends Command {
    ...
    async run (message, args, client) {
        try{
            if(message.channel.id === '1375026464151568514' || message.channel.id === '1014534670156824657' || message.channel.id === '1082828935143891005'){
                let embed = new Discord.MessageEmbed().setColor('#ff0000').setAuthor(".ru", 'https://cdn..ru/scpsl/img/etc/fydne.png', 'https://.ru');
                ...
                for (let i = 0; i < adms.length; i++) {
                    ...
                    if(_ids2 > 5){
                        ...
                        _ids2 = 0;
                        embed = new Discord.MessageEmbed().setColor('#ff0000').setAuthor(".ru", 'https://cdn..ru/scpsl/img/etc/fydne.png', 'https://.ru');
                    }
