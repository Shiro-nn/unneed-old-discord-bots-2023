...
class clear extends Command {
    ...
    async run (message, args, data) {
        ...
        if(!amount || isNaN(amount) || parseInt(amount) < 1){
            ...
            .setColor("#ff0000")
            const __msg = await message.channel.send({embeds: [embd]});
        ...
        .setColor("#ffae00");
        let toDelete = await message.channel.send({embeds: [embed]});
        ...
        const IntervalBar = setInterval(() => {
            ...
            try{toDelete.edit({embeds: [embed]});}catch{}
        }, 3000);
        ...
        .setColor("#00ff19");
        await Edit(toDelete, {embeds: [embed]});
