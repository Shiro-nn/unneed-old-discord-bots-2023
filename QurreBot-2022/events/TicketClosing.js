...
module.exports = class {
    ...
    async run(interaction) {
        ...
        try {
            ...
            exec(`${config.dotnet} ${config.directory}/DiscordChatExporter.CLI/DiscordChatExporter.Cli.dll export -t "${token}" -b -c ${channel.id} -f HtmlDark -o "${config.root_directory}/tickets/${hash}/index.html"`, async (error) => {
