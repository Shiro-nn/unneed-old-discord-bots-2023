    ...
    async run (message, args, data) {
        ...
        if(args[0]){
            ...
            let groupEmbed = new Discord.MessageEmbed()
                ...
                .addField(message.language.get("HELP_HEADINGS")[6], (cmd.conf.ownerOnly ? "`Создатель`" : (cmd.conf.memberPermissions.length > 0) ? cmd.conf.memberPermissions.map((a) => "`"+a+"`").join(", ") : "`Все`"))
        ...
        const inviteURL = "https://discord.gg/UCUBU2z";
