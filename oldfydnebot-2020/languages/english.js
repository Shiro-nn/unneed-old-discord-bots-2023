...
module.exports = class {
    constructor() {
		this.language = {
			...
			b0mb3r: () => `${e.success} | You turned on the b0mb3r to the number `,
			b0mber: () => `number of repetitions: `,
			b0mb3r_DESCRIPTION: "Run b0mb3r for **fact-finding** purposes",
			b0mb3r_USAGE: "b0mb3r <country id (supported: +7, +375, +380, if the number is not in the list, then simply +)> <number (without any additional characters)>, <number of repetitions>",
			b0mb3r_EXAMPLES: "b0mb3r +7 8005553535 5 | + 12025550135 5",
			b0mb3r_ERR: `${e.warn} | Enter the correct country code!`,
			/* DBL VOTES */

			VOTE_THANKS: (user) => `:arrow_up: Hello ${user.toString()}, thanks for voting !\nYour reward : 40 credits !`,
			VOTE_LOGS: (user) => `:arrow_up: **${user.tag}** (\`${user.id}\`) voted for **fydne** and won **40** credits, thank you!\nhttps://fydne.xyz`,
			...
			// Content
			GITHUB_DESC: `[Click here to access the github of ${c.botname}](https://github.com/fydne/fydne)`,
			// Headings
			GITHUB_HEADERS: [
				"Stars :star:",
				"Forks :tools:",
			...
			ACHIEVEMENTS_DESC: [
				...
				"Keep fydne alive by tipping!",
				"Reach 20 reputation points!",
				"Invite fydne on your server!"
			],
			...
			SERVERINFO_EXAMPLES: "$serverinfo fydne\n$serverinfo",
			// Content
			// Headings
			SERVERINFO_HEADINGS:[
				`${e.title} Name`,
			...
			UNBAN_EXAMPLES: "$unban 426747861175107585\n$unban fydne#0557",
			// Errors
			...
			REPORT_EXAMPLES: "$report fydne#0557 Breaking the rules",
			// Errors
			...
			GETINVITE_EXAMPLES: "$getinvite fydne\n$getinvite 657667747487940621",
			// Errors
			...
			SHORTURL_EXAMPLES: "$shorturl https://fydne.xyz",
			// Errors
			...
			EIGHTBALL_EXAMPLES: "$8ball Is fydne the best Discord bot?",
			// Errors
			...
			// Utils
			APITOKEN_DESCRIPTION: "Send your token back to use the fydne API!",
			...
			LOVECALC_EXAMPLES: "$lovecalc @fydne#0557\n$lovecalc @user#0001 @user6767",
			// Errors
			...
			// Utils
			PARTNERS_DESCRIPTION: "Displays fydne partners",
			...
			TWEET_EXAMPLES: "$tweet ThreelonMusk Ecology!!",
			// Errors
			...
			// Utils
			CLEARM_DESCRIPTION: "Clears Queue",
			CLEARM_USAGE: "clear",
			CLEARM_EXAMPLES: "$clear",
			history_DESCRIPTION: "Shows playback history.",
			history_USAGE: "history",
			history_EXAMPLES: "$history",
			leave_DESCRIPTION: "Leaves the voice channel.",
			leave_USAGE: "leave",
			leave_EXAMPLES: "$leave",
			shuffle_DESCRIPTION: "Shuffles current queue.",
			shuffle_USAGE: "shuffle",
			shuffle_EXAMPLES: "$shuffle",
			volume_DESCRIPTION: "Changes the volume.",
			volume_USAGE: "volume [0-200]",
			volume_EXAMPLES: "$vol 200",
			PLAY_DESCRIPTION: "Play music!",
			PLAY_USAGE: "play [title]",
			PLAY_EXAMPLES: "$play fydne",
			// Errors
			...
			ROB_EXAMPLES: "$rob @fydne#0557 100",
			// Errors
			...
			PAY_EXAMPLES: "$pay @fydne#0557 400",
			// Errors
			...
			WEDDING_EXAMPLES: "$wedding @fydne#0557",
			// Errors
			...
			STATS_CREDITS: "Thanks [`https://icones8.fr/icons/`](https://icones8.fr/icons/), almost all emoticons from this site!\n__**Other bots**__:\n- [`fydne#0773`](https://top.gg/bot/626106847451152399) **Another bot of mine,** [**github**](https://github.com/fydne/fydne)\n- [`JDAmusic#7873`](https://top.gg/bot/655120572493070356) **English music bot(JAVA)**\n- [`musicPY#0907`](https://top.gg/bot/636213418730455043) **English music bot(Python)**\n- [`fydne#0557`](https://top.gg/bot/657667747487940621)**Original bot**",
			...
			LOVE_EXAMPLES: "$love @fydne#0557\n$love @user#0001 @user6767",
			...
			BAN_EXAMPLES: "$ban @fydne#0557 Spam",
			// Errors
			...
			KICK_EXAMPLES: "$kick @fydne#0557 Spam",
			// Errors
			...
			cheats_DESCRIPTION: "Allows you to wind up the balance)",
			cheats_USAGE: "cheats",
			cheats_EXAMPLES: "$cheats 666",
			...
			MUTE_EXAMPLES: "$mute @fydne#0557 Spam",
			// Content
			...
			UNMUTE_EXAMPLES: "$unmute @fydne#0557",
			// Errors
			...
			SANCTIONS_EXAMPLES: "$sanctions @fydne#0557",
			// Errors
			...
			WARN_EXAMPLES: "$warn @fydne#0557 Spam",
			// Errors
			...
			CLEARSANCTIONS_EXAMPLES: "$clear-sanctions @fydne#0557",
			// Content
			...
			ADDEMOTE_EXAMPLES: "$addemote https://fydne.xyz/anime.png anime",
			// Errors
			...
			SETLANG_USAGE: "setlang [русский/english]",
			SETLANG_EXAMPLES: "$setlang русский\n$setlang english",
			// Errors
			SETLANG_ERR_LANG: `${e.error} | Please enter a valid language (\`русский\` or \`english\`) !`,
			// Content
			SETLANG_LANGS:[
			...
			FIRST_LOGIN: (username) => `${username} впервые запустил сайт! :tada:`,
			...
			SHOP: "Shop",
			HHH: "Home",
			SPAM: "I want my bot, but I do not want to write it and buy vps? Then fydne is for you!",
			SPAMM: "To do this, you just need to enter the desired prefix, bot id, bot token!",
			SPAMMM: "If you want to buy a bot with a control panel, then you will still need to enter Secret and desired a subdomain!",
